...
class PPO:
    ...
    @ray.remote
    @torch.no_grad()
    def sample(iteration_count, gamma, lam, env_fn, policy, critic, max_steps, max_traj_len, deterministic=False, anneal=1.0, term_thresh=0):
        """
    ...
    def sample_parallel(self, env_fn, policy, critic, min_steps, max_traj_len, deterministic=False, anneal=1.0, term_thresh=0):
        ...
        worker = self.sample
        args = (self.iteration_count, self.gamma, self.lam, env_fn, policy, critic, min_steps // self.n_proc, max_traj_len, deterministic, anneal, term_thresh)
        ...
        for itr in range(n_itr):
            ...
            for epoch in range(self.epochs):
                ...
                for indices in sampler:
                    ...
                    obs_batch, action_batch, return_batch, advantage_batch, mask = None, None, None, None, None
                    actor_loss, entropy_penalty, critic_loss, approx_kl_div, mirror_loss, clip_fraction = None, None, None, None, None, None
